# from accession import accessionScraper, accessionParser
# from report import reportScraper, parsers, reportValidator
...
#     reportScraper.scrap(accessionDto=accessionDto)

#     with open('reportTest.txt', "w") as f:
#         f.write(str(reportScraper.scraped_data))
